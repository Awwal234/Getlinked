...
import IntroHack from './IntroHack.vue'
...
<template>
    <div class="">
        <div class="md:flex mb-[0px] pt-[210px] w-full hidden justify-between">
            ...
            <div>
                <div
                    class="text-[#fff] top-[-20px] mb-[2px] relative right-[55px] italic mont text-[25px] lg:text-[36px] font-[700]">
        ...
        <!--mobile-->
        <div class="md:hidden mb-[10px] pt-[110px] px-[33px]">
        ...
        <!--end mobile-->
        <div
            class="w-full bg_space linked_border lg:items-top lg:flex pb-[0px] pl-[0px] pr-[0px] md:pr-[128px] md:pl-[128px] lg:pl-[128px] lg:pr-[0px]">
            <div class="w-full pl-[33px] pr-[33px] md:pr-[0px] md:pl-[0px] mx-auto lg:mx-0 lg:w-[50%]">
                ...
                <div>
                    <div class="w-full">
                        <div
                            class="font-[700] z-[10] relative text-center lg:text-left mx-auto lg:mx-0 text-[#fff] text-[32px] md:text-[60px] lg:text-[80px] clashmd">
                ...
                <div
                    class="relative lg:mb-[-45px] w-[80%] md:w-[85%] lg:w-full text-center lg:text-left text-[13px] mx-auto lg:mx-0 md:text-[20px] text-[#fff] font-[400] mont top-[-25px] md:top-[-40px] lg:top-[-80px]">
                ...
                <div
                    class="mx-auto mb-[11.77px] lg:mb-[0px] md:mt-[77px] space-x-[20px] md:space-x-[20px] flex w-fit lg:mx-0">
                    <div class="text-[#fff] md:leading-[133%] text-[48px] md:text-[64px] font-[400]">
                        00<span class="mont text-[14px]">H</span>
                    </div>
                    <div class="text-[#fff] md:leading-[133%] text-[48px] md:text-[64px] font-[400]">
                        00<span class="mont text-[14px]">M</span>
                    </div>
                    <div class="text-[#fff] md:leading-[133%] text-[48px] md:text-[64px] font-[400]">
                        00<span class="mont text-[14px]">S</span>
                    </div>
                </div>
            </div>
            <!--line 2 or flex-->
...
.anime_star {
    animation: 2s glow infinite backwards;
}
