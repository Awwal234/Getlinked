...
<template>
    <div>
        <div
            class="md:pt-[61px] partner_space linked_border lg:items-center pt-[29px] pb-[55px] md:pb-[62px] w-full px-[57px] md:px-[128px]">
...
.partner_space {
    background-image: url("../../img/partnerbackg.png");
